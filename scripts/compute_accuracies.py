...
from eval.cbd_eval import calculate_cbd_accuracy
...
def evaluate_all_descriptors(
    descriptors_path,
    model_name,
    output_path="results/cbd_results.json",
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_path", type=str, default="results/accuracy.json")
